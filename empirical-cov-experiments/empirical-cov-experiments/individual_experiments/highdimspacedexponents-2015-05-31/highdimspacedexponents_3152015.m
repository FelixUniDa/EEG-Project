%% File: highdimensioncentroid_2952015.m
...
upperlimit = 11000;
step = 2000;
% exponents = '{6,6,6,6,6,6,6,6,4,4}';
% exponents = 'Join[Table[x,{x,dim-2,10}], {2.1, 2.1}]';
exponents = '{2.01, 2.89778, 3.78556, 4.67333, 5.56111, 6.44889, 7.33667, 8.22444, 9.11222, 10.}';
numberofruns = 10;
