...
%% ----- Start logging if running full experiment
...
plot(sizes, reshape(meandata(1,4,:), size(sizes)), '-.xm');

y = ylim;
ylim([0 y(2)]);

legend('FastICA - pow3', 'FastICA - pow3 damped', ...
    'FastICA - tanh', 'FastICA - tanh damped', ...
    'JADE', 'JADE damped', ...
