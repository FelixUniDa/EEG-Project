...
# import sys
# sys.path.insert(1, 'D:\Daten\ETiT\11_Semester\Robust_Signal_processing\MNE\robustsp-master\robustsp')
...
def whitening(x, type='sample'):
    ...
    cov = covariance(centered_X)  # np.cov(centered_X, bias=True) # covariance(centered_X) #calculate Covariance matrix between signals
